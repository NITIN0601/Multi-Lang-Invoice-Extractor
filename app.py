...
def input_image_details(uploaded_file):
    ...
    #         pix = page.get_pixmap()
    #         bytes_data = pix.tobytes(output='png')
    #         image_parts.append({"mime_type": "image/png",
    #                             "data": bytes_data, 
    #                             "page": i+1})
    # else:
...
file_type = st.radio ('Choose file type :',['Image'],index=0)
# file_type = st.radio ('Choose file type :',['Image','PDF'],index=0) # TO-DO next version
